...
int avlTreeCheck(tAVLTree *pTree, TREE_NODE *pNode)
{
    ...
    if (tree_root)
    {
         ...
         *父亲节点的左右子树都是自己
         *******************************/
        if ((tree_root->left_child != pNode && tree_root->right_child != pNode) || (tree_root->left_child == pNode && tree_root->right_child == pNode))
            return 0;
    }
     ...
     *右子树的父亲节点不是自己
     *****************************/
    if ((pNode->left_child && pNode->left_child->tree_root != pNode) || (pNode->right_child && pNode->right_child->tree_root != pNode))
        return 0;
 ...
 * Returns         :  无
 ******************************************************************/
static int avlDelBalance(tAVLTree *pTree, TREE_NODE *pNode, int L_R_MINUS)
{
    TREE_NODE *tree_root = AVL_NULL;
 ...
 * Returns         :  无
 *********************************************************************/
void AVL_TREE_LOCK(tAVLTree *pTree, int timeout)
{
    if (!pTree
#if OS == 3 || OS == 4
        || !pTree->sem
 ...
 * Returns         :  无
 *********************************************************************/
void AVL_TREE_UNLOCK(tAVLTree *pTree)
{
    if (!pTree
#if OS == 3 || OS == 4
        || !pTree->sem
 ...
 * Returns         :  无
 *********************************************************************/
void AVL_TREENODE_FREE(tAVLTree *pTree, TREE_NODE *pNode)
{
    if (!pTree || !pNode)
        return;
 ...
 * Returns         :  1:成功  0:失败
 *********************************************************************************/
static int orderListInsert(tAVLTree *pTree, TREE_NODE *pNode, TREE_NODE *pInsertNode, int prev_or_next)
{
 ...
 * Returns         :  1:成功   0:失败
 ********************************************************************/
static int orderListRemove(tAVLTree *pTree, TREE_NODE *pRemoveNode)
{
 ...
 *                         失败:  AVL_NULL
 *********************************************************************/
TREE_NODE *avlTreeFirst(tAVLTree *pTree)
{
    if (!pTree)
        return AVL_NULL;
 ...
 *                         失败:  AVL_NULL
 *********************************************************************/
TREE_NODE *avlTreeLast(tAVLTree *pTree)
{
    if (!pTree)
        return AVL_NULL;
 ...
 *                         0:失败
 ******************************************************************************************/
static int avlTreeInsert(tAVLTree *pTree, TREE_NODE **ppNode, TREE_NODE *pInsertNode, int *growthFlag)
{
    int compFlag = 0;
    TREE_NODE *pNode = (TREE_NODE *)(*ppNode);
 ...
 *                     F和E互换指针
 ********************************************************************/
static int avlTreeRemove(tAVLTree *pTree, TREE_NODE *pRemoveNode)
{
    int compFlag = 0;
    TREE_NODE *tree_root = AVL_NULL;
    TREE_NODE *p = AVL_NULL;
...
失败 :   0
 ********************************************************************/
int avlTreeDestroy(tAVLTree *pTree)
{
...
失败 :   0
 ********************************************************************/
int avlTreeFlush(tAVLTree *pTree)
{
    TREE_NODE *pNode = AVL_NULL;
...
失败 :   0
 *******************************************************************/
int avlTreeAdd(tAVLTree *pTree, TREE_NODE *pInsertNode)
{
...
失败 :   AVL_NULL
 ********************************************************************/
TREE_NODE *avlTreeFind(tAVLTree *pTree, TREE_NODE *pKeyNode)
{
...
树里面的节点成员总数
 ********************************************************************/
unsigned int avlTreeCount(tAVLTree *pTree)
{
    if (!pTree)
        return 0;
